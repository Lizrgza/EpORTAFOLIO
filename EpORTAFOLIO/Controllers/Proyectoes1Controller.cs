...
{
    public class Proyectoes1Controller : Controller
    {
        ...
        // GET: Proyectoes1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Proyectoes1/Create
